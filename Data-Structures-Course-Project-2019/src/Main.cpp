...
void writeOperations() {
	...
	std::cout << "16. Sort the student list of Data Management Course with selection sort in order to names" << std::endl; // It will be edit when the database avl tree is added.
